...
const getWeather_data = async () => {
    ...
    try {
        ...
        w_temp.innerHTML = `${(main.temp - 273.15).toFixed(2)}&#176;C`;
        w_min.innerHTML = `min: ${(main.temp_min - 273.15).toFixed(2)}&#176;C`;
        w_max.innerHTML = `max: ${(main.temp_max - 273.15).toFixed(2)}&#176;C`;
...
window.addEventListener("load", getWeather_data);
